...
- [SignalR 实现详细分析](SIGNALR_IMPLEMENTATION_ANALYSIS.md) （英文）
- [SignalR 优化实施总结](SIGNALR_OPTIMIZATION_SUMMARY.md) （英文）
- [SignalR 优化建议摘要](SIGNALR优化建议摘要.md) （中文快速参考）
- [SignalR 客户端重连策略指南](SIGNALR_CLIENT_RETRY_POLICY.md)
